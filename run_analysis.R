...
#maybe do that in one step using the earlier read.table?
...
#I don't think we want to "Merge" these by joining at all. 
#I think we want to append them to have a complete set of subjects? No?
...
#I was trying to make sure I carried through the necessary first two columns, that don't have mean or std in name
...
#brute force replace all values of activity label with names
